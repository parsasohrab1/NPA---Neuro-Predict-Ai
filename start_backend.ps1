# NeuroPredict-AI Backend Startup Script
# This script configures and starts the backend server
...
Write-Host "  - Using SQLite database (no PostgreSQL required)" -ForegroundColor Yellow
Write-Host "  - Server will run on port 8001" -ForegroundColor Yellow
Write-Host "  - Redis optional (will work without it)" -ForegroundColor Yellow
Write-Host ""
