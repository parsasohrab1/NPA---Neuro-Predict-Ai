...
- ✅ API endpoints برای اپیزود، ویزیت، متریک، timeline و trend
- ✅ صفحه Longitudinal در داشبورد ادمین (timeline + trend chart)

**کمبودها**:
- ❌ مقایسه تصاویر MRI در زمان‌های مختلف
- ❌ محاسبه سرعت پیشرفت بیماری و هشدارهای خودکار
- ❌ گزارش‌های دوره‌ای (ماهانه، فصلی، سالانه)
- ❌ ابزارهای تعاملی (drag/drop تایم‌لاین، لینک به گزارش‌های دیگر)
- ❌ تحلیل‌های پیشرفته (differences overlay, volume change heatmap)

**اقدامات مورد نیاز**:
1. Image comparison tool و سرویس پردازش تصویری
2. الگوریتم تحلیل سرعت پیشرفت و هشدار
3. تولید گزارش‌های دوره‌ای/خلاصه برای export
4. توسعه UI پیشرفته (نمودارهای چندمحوره، مقایسه multi-episode)
